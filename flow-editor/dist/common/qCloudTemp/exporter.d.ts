...
export interface IExportItem {
    id: string;
    ver: string;
    type: "settings_yaml" | "alert_qjson" | "pipeline_qjson" | "localProxy_yaml" | "globalLocalization_qjson" | "loading_qjson" | "componentList_js" | "namedComps" | "qjsons" | "css" | "containerServices_js" | "bpmn" | "process" | "entityDesigner" | "flow" | "assetList_js" | "lottie" | "appSettings" | "png" | "jpg" | "jpeg" | "svg" | "gif" | "woff" | "md" | "woff2" | "ttf" | "otf" | "certificate" | "constant" | "containerServIntelli_ts" | "theme" | "container" | "befunc" | "endpoint";
    size?: number;
    path: string;
    name: string;
    isRootPage?: boolean;
